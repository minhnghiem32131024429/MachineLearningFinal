...
def generate_sports_caption(analysis_result):
    ...
    if action_phrases:
        print(f"DEBUG - Using existing specific action: {action_phrases[0]}")
    elif action_quality:
    ...
    if 'sports_analysis' in analysis_result and 'best_sport_action' in analysis_result['sports_analysis']:
        ...
        if best_action_result and best_action_result.get('action') and best_action_result.get('sport_match'):
            ...
            if action_confidence > 0.5:  # Giảm từ 0.6 xuống 0.5
                ...
                print(f"DEBUG - action_phrases now contains: {action_phrases}")
    ...
    try:
        ...
        print(f"DEBUG - Using fallback action phrase: {action_phrases[0]}")
    ...
    # DEBUG: Print all parts before combining
    print(f"DEBUG - All caption parts: {all_parts}")
